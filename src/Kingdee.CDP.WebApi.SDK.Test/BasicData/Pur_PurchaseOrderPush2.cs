...
{
    [TestClass]
    public class Pur_PurchaseOrderPush2
    {
        ...
        [TestMethod]
        public void Apurchaseorder_Draft()
        {
        ...
        public void DpurchaseorderPushPochange_push()
        {
            ...
            OperatorResult sRet = clienter.Push("PUR_PurchaseOrder", new PushParam()
            {
                Numbers = new string[1] { Number },
                RuleId = "PUR_PurchaseOrder-PUR_POChange", //（单据转换规则唯一码）
                TargetBillTypeId = "d588ab5aeb23490aadbb665874b1eabf",
                TargetFormId = "PUR_POChange",
                TargetOrgId =0,
